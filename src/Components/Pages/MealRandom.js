      ...
      <Container className={classes.root}>
        <div>
          <Typography className={classes.mainText} variant="h4">
            How to make:<i> {random[0].strMeal}</i>
          </Typography>
          <img
            className={classes.image}
            src={random[0].strMealThumb}
            alt={random[0].strMealThumb}
          />
          <Typography className={classes.dishText}>
            {random[0].strArea}Dish
          </Typography>
          <Typography className={classes.infoText}>
            <b>• Category:</b> {random[0].strCategory}
          </Typography>
          {random[0].strTags ? (
            <Typography className={classes.infoText}>
              <b>• Tags:</b> {random[0].strTags}
            </Typography>
          ) : (
            <Typography className={classes.infoText}>
              <b>• No Tags</b>
